...
const Home = () => {
  return (
    <section
      id="home"
      className="h-screen flex flex-col justify-center items-start px-6 sm:px-12 md:px-20 lg:px-32 text-white relative overflow-hidden"
      style={{
    ...
    >
      ...
      {/* Subheading */}
      <motion.h2
        className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold text-gray-100 mb-4 md:mb-6 relative z-10 drop-shadow-[0_3px_12px_rgba(0,0,0,0.95)]"
        initial={{ opacity: 0, y: -10 }}
